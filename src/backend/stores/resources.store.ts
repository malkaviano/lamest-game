  ...
  private extractActors() {
    return actorStore.actors.map((a) => {
      ...
      return {
        ...
        immunities: a.immunities.map((i) => i as EffectTypeLiteral),
        cures: a.cures.map((i) => i as EffectTypeLiteral),
        vulnerabilities: a.vulnerabilities.map((i) => i as EffectTypeLiteral),
        resistances: a.resistances.map((i) => i as EffectTypeLiteral),
