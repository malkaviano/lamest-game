...
@Component({
  ...
  template: `
    <div
      ...
      [ngClass]="'progress-bar-container--' + data.type"
    >
...
export class AnimatedProgressBarWidgetComponent
  implements OnChanges, AfterViewInit
{
  @Input() data!: ProgressBarData;

  @ViewChild('fill', { static: true }) fillElement!: ElementRef<HTMLDivElement>;
  @ViewChild('shine', { static: true })
  shineElement!: ElementRef<HTMLDivElement>;
